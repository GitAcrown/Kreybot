...
class Payday:
    ...
    def __init__(self, bot):
        ...
        self.bad = ["Un tir à eu lieu avec la police locale et {} est touché." + "\n" +
                    ...
                    "`{} en prison.`",
                    "{} a eu un claquage et pleure comme une petite fille sur le sol." + "\n" +
                    "`{} en PLS.`",
                    ...
                    "`{} en prison.`",
                    "{} a été capturé en partant aux toilettes" + "\n" +
                    "`{} en prison.`",
                    ...
                    "`{} mort.`",
                    "{} a paniqué en entendant les sirènes et s'est fait reperé." + "\n" +
                    "`{} en prison.`",
                    ...
                    "`{} en prison.`",
                    "{} prend un selfie avec le gardien assassiné." + "\n" +
                    "`{} en prison.`",
                    ...
                    "`{} sourd et en prison.`",
                    "'ALLAHU WAKBAR!', pas de chances, un terroriste était dans la banque et a explosé {}." + "\n" +
                    "`{} mort.`",
                    "'NERF THIS!', à été la dernière chose que {} à entendu... dans ses rêves." + "\n" +
                    "`{} en prison.`",
