...
#
# Krey, Discord Bot dérivé de Red de Twentysix26 par Acrown. Version grand public.
#

description = """
Krey ~ Discord Bot by Acrown
"""
...
def load_cogs():
    ...
    if owner_cog is None:
        print("AAAAH ! Pourquoi le module Owner n'est pas présent ? Il me le faut absolument ! Veuillez me fournir une nouvelle copie de ce module !.")
        exit(1)
